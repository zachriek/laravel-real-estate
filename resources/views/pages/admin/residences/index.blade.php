                ...
                <tr>
                  ...
                  <td>
                    @if ($residence->image === null)
                      <img class="img-fluid" src="{{ 'https://source.unsplash.com/random/300x300?residence' }}"
                        alt="residence" width="100" loading="lazy">
                    @else
                      <img class="img-fluid" src="{{ url('assets/admin/img/' . $residence->image) }}" alt="residence"
