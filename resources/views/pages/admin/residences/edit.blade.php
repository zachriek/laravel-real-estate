          ...
          <div class="card-body">
            <form action="{{ route('admin.residences.update', $residence->slug) }}" method="POST"
              ...
              @if ($residence->image !== null)
                <img class="img-thumbnail" src="{{ url('assets/admin/img/' . $residence->image) }}" alt="residence"
                  loading="lazy">
              @else
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                  id="name" value="{{ old('name', $residence->name) }}">
                @error('name')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('location') is-invalid @enderror" name="location"
                  id="location" value="{{ old('location', $residence->location) }}">
                @error('location')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('bed') is-invalid @enderror" name="bed"
                  id="bed" value="{{ old('bed', $residence->bed) }}">
                @error('bed')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('bath') is-invalid @enderror" name="bath"
                  id="bath" value="{{ old('bath', $residence->bath) }}">
                @error('bath')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('size') is-invalid @enderror" name="size"
                  id="size" value="{{ old('size', $residence->size) }}">
                @error('size')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
