      ...
      <div class="row">
        <div class="residence-thumbnail col-lg-6">
          <img class="img-fluid" src="{{ url('assets/base/img/residence01-img.png') }}" alt="residence"
            data-fancybox="residence-thumb" loading="lazy" />
          <div class="residence-thumbs">
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <img class="img-fluid" src="{{ url('assets/base/img/residence02-img.png') }}" alt="residence"
                    data-fancybox="residence-thumb" loading="lazy" />
                </div>
                <div class="swiper-slide">
                  <img class="img-fluid" src="{{ url('assets/base/img/residence03-img.png') }}" alt="residence"
          ...
          <div class="card card-user">
            <div class="card-body card-user">
              ...
              <div class="d-flex my-4" style="flex-wrap: wrap; gap: 1rem">
                <form action="{{ route('carts.store', [$residence->slug, 'in_cart']) }}" method="POST">
                  @csrf
                ...
                <form action="{{ route('carts.store', [$residence->slug, 'pending']) }}" method="POST">
                  @csrf
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item mb-2" role="presentation">
              <button class="nav-link active" id="pills-description-tab" data-toggle="pill"
                data-target="#pills-description" type="button" role="tab" aria-controls="pills-description"
                aria-selected="true">
                Description
              </button>
            </li>
            <li class="nav-item ml-2" role="presentation">
              <button class="nav-link" id="pills-reviews-tab" data-toggle="pill" data-target="#pills-reviews"
