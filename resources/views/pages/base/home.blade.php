<x-base-layout title="Home">
      ...
      <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-center mb-4 mb-md-0">
          ...
          <div class="input-group mt-4">
            <input type="text" class="form-control" placeholder="Search here..." style="padding: 2rem 1.4rem" />
        ...
        <div class="col-md-6">
          <img class="img-fluid" src="{{ url('assets/base/img/hero-img.png') }}" alt="hero-img" loading="lazy" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          <a href="{{ route('residences.index') }}" class="btn btn-lg btn-primary shadow-sm d-none d-lg-inline-block">
  ...
  <section id="offer">
    <img src="{{ url('assets/base/img/arrow-shade-pattern.png') }}" alt="arrow-shade-pattern"
      class="overlay-img img-fluid" loading="lazy" />
    <div class="container">
      <div class="row mb-4">
        <div class="col-12 text-center">
      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-4 col-12 mb-5">
          <img src="{{ url('assets/base/img/loupe.png') }}" alt="loupe-icon" class="offer-icon" loading="lazy" />
        ...
        <div class="col-md-4 col-12 mb-5">
          <img src="{{ url('assets/base/img/tag.png') }}" alt="tag-icon" class="offer-icon" loading="lazy" />
          <h5 class="card-title text-light">Affordable Prices</h5>
          <p class="card-text text-light">Urna, massa aliqua dui pellentesque. Ac, gravida in. Diam vitae, nec
            mattis lectus quam pretium amet facilisis.</p>
        </div>
        <div class="col-md-4 col-12 mb-5">
          <img src="{{ url('assets/base/img/quick.png') }}" alt="quick-icon" class="offer-icon" loading="lazy" />
  ...
  <section id="contact" style="background: url('/assets/images/residence-bg.png') no-repeat; background-size: cover">
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-6 mb-5">
          <img src="{{ url('assets/base/img/home-1-img.png') }}" alt="home-1-img" class="img-fluid" loading="lazy" />
        </div>
        <div class="col-lg-3 col-6 mb-5">
          <img src="{{ url('assets/base/img/home-2-img.png') }}" alt="home-2-img" class="img-fluid" loading="lazy" />
        </div>
        <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start">
          ...
          <a href="https://api.whatsapp.com/send?phone=6281274786920"
            class="btn btn-lg btn-primary shadow-sm d-none d-lg-inline-block" target="_blank" rel="noreferrer">
            <i class="bi bi-whatsapp"></i>
            <span class="mx-2">Get In Touch</span>
          </a>
          <a href="https://api.whatsapp.com/send?phone=6281274786920" class="btn btn-primary shadow-sm d-lg-none"
